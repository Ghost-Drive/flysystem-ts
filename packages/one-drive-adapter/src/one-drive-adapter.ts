...
export class OneDriveAdapter implements IFlysystemAdapter {
    ...
    write(pathOrParentIdName: PathOrId, contents: string | Buffer, config?: VisibilityInterface | undefined): Promise<Partial<StorageItem>> {
        throw new Error('Method not implemented.');
    }

    writeStream(pathOrParentIdName: PathOrId, resource: Readable, config?: VisibilityInterface | undefined): Promise<Partial<StorageItem>> {
        throw new Error('Method not implemented.');
    }
    ...
    createDirectory(pathOrParentIdName: PathOrId, config?: VisibilityInterface | undefined): Promise<{ id: string, isFolder: boolean }> {
        throw new Error('Method not implemented.');
    }
